...
namespace RRQMService.Ssl
{
    public static class SslTCP
    {
        ...
        {
            Console.WriteLine("1.简单SslTCP服务器");
        ...
        static void StartSslTcpService()
        {
            ...
            service.Setup(new RRQMConfig()
                ...
                .SetServiceSslOption(new ServiceSslOption() { Certificate = new X509Certificate2("RRQMSocket.pfx", "RRQMSocket"), SslProtocols = SslProtocols.Tls12 }))
                .Start();
