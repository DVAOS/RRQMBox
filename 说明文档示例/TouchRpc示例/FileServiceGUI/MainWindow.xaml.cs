...
namespace FileServiceGUI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void FileService_Disconnected(TcpTouchRpcSocketClient client, MesEventArgs e)
        {
            this.UIInvoke(() =>
            {
        ...
        private void FileService_Connected(TcpTouchRpcSocketClient client, RRQMEventArgs e)
        {
            this.UIInvoke(() =>
            {
