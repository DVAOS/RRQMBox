...
namespace EERPCServiceDemo
{
    public partial class Form1 : Form
    {
        ...
        private void TcpRpcParser_Connected(TcpTouchRpcSocketClient client, RRQMEventArgs e)
        {
            Debug.WriteLine("Connected");
        }

        private void TcpRpcParser_Disconnected(TcpTouchRpcSocketClient client, RRQMSocket.MesEventArgs e)
        {
            lock (this)
            {
        ...
        private void TcpRpcParser_Handshaked(TcpTouchRpcSocketClient client, RRQMEventArgs e)
        {
        ...
        TcpTouchRpcService tcpRpcService;
