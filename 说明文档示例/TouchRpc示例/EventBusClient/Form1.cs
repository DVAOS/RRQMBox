...
namespace EERPCClientDemo
{
    public partial class Form1 : Form
    {
        ...
        TcpTouchRpcClient tcpRpcClient;
        RpcStore m_rpcCerter = new RpcStore();

        private void button3_Click(object sender, EventArgs e)
        {
            this.tcpRpcClient = new TcpTouchRpcClient();
            m_rpcCerter.AddRpcParser("tcpRpcClient", this.tcpRpcClient);
            this.tcpRpcClient.Disconnected += TcpRpcClient_Disconnected;
            tcpRpcClient.Setup("127.0.0.1:7789").Connect(1000 * 100);
        ...
        {
            m_rpcCerter.RegisterServer<ThisRpcServer>();
    ...
    class ThisRpcServer:ServerProvider
    {
        [TouchRpc]
