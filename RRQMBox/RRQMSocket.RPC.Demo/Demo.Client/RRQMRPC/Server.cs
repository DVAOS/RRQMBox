...
public class Server
{
public Server(RRQMSocket.RPC.IRPCClient client)
{
this.Client=client;
}
public RRQMSocket.RPC.IRPCClient Client{get;private set; }
...
public  async void BeginTestNullReturnNullParameter (InvokeOption invokeOption = null)
{
if(Client==null)
{
...
public  async Task<System.String> BeginTestStringReturnNullParameter (InvokeOption invokeOption = null)
{
if(Client==null)
{
throw new RRQMRPCException("RPCClient为空，请先初始化或者进行赋值");
...
public  async void BeginTestNullReturnStringParameter (System.String name,InvokeOption invokeOption = null)
{
if(Client==null)
{
throw new RRQMRPCException("RPCClient为空，请先初始化或者进行赋值");
...
public  async void BeginTestClass1 (RRQMRPC.RRQMTest.Test01 test01,InvokeOption invokeOption = null)
{
if(Client==null)
{
throw new RRQMRPCException("RPCClient为空，请先初始化或者进行赋值");
...
public  async Task<RRQMRPC.RRQMTest.Test02> BeginTestClass1AndClass2 (RRQMRPC.RRQMTest.Test01 test01,InvokeOption invokeOption = null)
{
if(Client==null)
{
throw new RRQMRPCException("RPCClient为空，请先初始化或者进行赋值");
...
public  async void BeginTestClass3 (RRQMRPC.RRQMTest.Test03 test03,InvokeOption invokeOption = null)
{
if(Client==null)
{
throw new RRQMRPCException("RPCClient为空，请先初始化或者进行赋值");
...
public  async void BeginTestGetSocketClient (System.String iDToken,InvokeOption invokeOption = null)
{
if(Client==null)
{
throw new RRQMRPCException("RPCClient为空，请先初始化或者进行赋值");
...
public  async void BeginTestSleep (InvokeOption invokeOption = null)
{
if(Client==null)
{
throw new RRQMRPCException("RPCClient为空，请先初始化或者进行赋值");
